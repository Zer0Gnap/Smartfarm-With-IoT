            ...
            <div class="col-md-6 d-flex align-items-stretch grid-margin">
              ...
              if ($_POST) {
				...
				$con_pass = $_POST['con_pass'];
              	...
              	if (empty($old_pass) || empty($new_pass) || empty($old_pass)) {
              		echo 'FILL ALL PLZ';
              ...
              ?>
                      ...
                      <form action method="post" class="forms-sample">
                        <div class="form-group">
                          ...
                          <input name="old_pass" type="password" class="form-control" id="exampleInputEmail1" placeholder="Old password">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">New password</label>
                          <input name="new_pass" type="password" class="form-control" id="exampleInputPassword1" placeholder="New password">
                        </div>
						 <div class="form-group">
                          <label for="exampleInputPassword1">Confirm password</label>
                          <input name="con_pass" type="password" class="form-control" id="exampleInputPassword1" placeholder="Confirm password">
                        </div>
                        <button type="submit" class="btn btn-success mr-2">Submit</button>
                        <button type="reset" value="Reset" class="btn btn-light">Clear</button>
                      </form>
                    </div>
                  </div>
                </div>
